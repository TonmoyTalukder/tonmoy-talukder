    ...
    <div id="recent" className="mt-3">
        ...
        <hr/>
            ...
            <ul style={{listStyleType: "none"}}>
                ...
                <span className="text-sky-600 hover:text-orange-400"><a href="https://confbim.com/" target="_blank" rel="noreferrer">BIM 2023</a></span></span>, Springer Lecture Notes in Networks and Systems.</p>
                </li>
                <li className='py-2'>
                ...
                <span className="text-sky-600 hover:text-orange-400"><a href="https://confbim.com/" target="_blank" rel="noreferrer">BIM 2023</a></span></span> conference.</p>
                </li>
                <li className='py-2'>
                <p className="text-justify"><span className="text-sm font-semibold">[August, 2022]</span> I have started <span style={{color: '#FF0000'}}>research</span>  under the supervision of Mr. G M Shahariar Shibli, Faculty, Department of Computer Science and Engineering, Ahsanullah University of Science and Technology.</p>
                </li>
            </ul>
            </div>
        <hr/>
