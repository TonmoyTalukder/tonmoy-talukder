        ...
        <hr/>
            <div>
                <ul style={{listStyleType: "none"}}>
                    <li>
                    <p><span class="text-sm font-semibold">💻 [February, 2023]</span> <span class="text-sky-700 font-bold">Bangla-KeywordExtractor</span></p>
                ...
                <ul style={{listStyleType: "none"}}>
                    <li>
                    <p><span class="text-sm font-semibold">💻 [January, 2023]</span> <span class="text-sky-700 font-bold">Bengali Hate Speech Classification</span></p>
                ...
                <ul style={{listStyleType: "none"}}>
                    <li>
                    <p><span class="text-sm font-semibold">💻 [October, 2022]</span> <span class="text-sky-700 font-bold">Diabetes Prediction Analysis</span></p>
                ...
                <ul style={{listStyleType: "none"}}>
                    <li>
                    <p><span class="text-sm font-semibold">💻 [March, 2022]</span> <span class="text-sky-700 font-bold">BookPedia Prototype - A Social Media (React + ASP.NET Framework Project)</span></p>
                ...
                <ul style={{listStyleType: "none"}}>
                    <li>
                    <p><span class="text-sm font-semibold">💻 [November, 2021]</span> <span class="text-sky-700 font-bold">Niche Product MERN Stack Web Application: The Niketan</span></p>
                    ...
                    <p>[<span class="text-sky-400 hover:text-orange-400"><a href="https://github.com/TonmoyTalukder/the-niketan-client-side">Frontend GitHub Repository</a></span>] [<span class="text-sky-400 hover:text-orange-400"><a href="https://github.com/TonmoyTalukder/the-niketan-server-side">Backend GitHub Repository</a></span>]</p>
                    </li>
                </ul>           
                <br></br>  
                <ul style={{listStyleType: "none"}}>
                    <li>
                    <p><span class="text-sm font-semibold">💻 [October, 2021]</span> <span class="text-sky-700 font-bold">Churning Telecom Company Prediction</span></p>
                ...
                <ul style={{listStyleType: "none"}}>
                    <li>
                    <p><span class="text-sm font-semibold">💻 [November, 2021]</span> <span class="text-sky-700 font-bold">MERN Stack Tourism Web Application: The Wayfarers</span></p>
                    ...
                    <b>Database:</b> MongoDB</p>
                    <p>[<span class="text-sky-400 hover:text-orange-400"><a href="https://github.com/TonmoyTalukder/the-wayfarers-client-side">Frontend GitHub Repository</a></span>] [<span class="text-sky-400 hover:text-orange-400"><a href="https://github.com/TonmoyTalukder/the-wayfarers-server">Backend GitHub Repository</a></span>]</p>
                    </li>
                </ul>          
                <br></br>       
                <ul style={{listStyleType: "none"}}>
                    <li>
                    <p><span class="text-sm font-semibold">💻 [August, 2021]</span> <span class="text-sky-700 font-bold">Test cricket analysis</span></p>
                ...
                <ul style={{listStyleType: "none"}}>
                    <li>
                    <p><span class="text-sm font-semibold">💻 [July, 2021]</span> <span class="text-sky-700 font-bold">Audi used car EDA</span></p>
