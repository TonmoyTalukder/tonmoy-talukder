...
const Intro = () => {
  ...
  <div class="w-full md:w-50">
    ...
    <div class="mt-2">
      ...
      <span class="text-center text-orange-600 hover:text-orange-400"><a href="https://drive.google.com/file/d/1auLsN9sgf4BrtH0NlQ9IjbYQNFHPi5U6/view" target="_blank">Curriculum Vitae</a></span> | <span class="text-center text-orange-600 hover:text-orange-400"><a href="https://www.linkedin.com/in/tonmoytalukder/" target="_blank">LinkedIn</a></span> | <span class="text-center text-orange-600 hover:text-orange-400"><a href="https://github.com/TonmoyTalukder" target="_blank">GitHub</a></span> | <span class="text-center text-orange-600 hover:text-orange-400"><a href="https://scholar.google.com/citations?user=_6Nj60QAAAAJ&hl=en" target="_blank">Google Scholar</a></span>
      </p>
      <p class="text-justify">
      I have pursued Bachelor of Science degree in Computer Science and Engineering at <span class="text-orange-600 hover:text-orange-400"><a href="https://www.aust.edu/" target="_blank" rel="noreferrer">Ahsanullah University of Science and Technology</a></span>.
    <br></br>
    <br></br>
