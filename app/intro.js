...
const Intro = () => {
  ...
  <div class="w-full md:w-50">
    <div class="mt-2">
      ...
      I have pursed Bachelor of Science degree in  at Computer Science and Engineering <span class="text-orange-600 hover:text-orange-400"><a href="https://www.aust.edu/" target="_blank">Ahsanullah University of Science and Technology</a></span>.
    <br></br>
    <br></br>
