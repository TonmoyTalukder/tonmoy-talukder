...
const Myresume = () => {
    ...
    const handleDownloadCV = () => {
        const link = document.createElement('a');
        link.href = 'https://drive.google.com/uc?id=1XxR5ZkPKPBXYcAAkoIYKpU5NOYivrUfC';
        link.target = '_blank';
  ...
  return (
    ...
    <div id="cv" className="mt-3">
        ...
        <div>
            ...
            <iframe src="https://drive.google.com/file/d/1XxR5ZkPKPBXYcAAkoIYKpU5NOYivrUfC/preview" frameborder="0" width="100%" className='cv-special-new' style={{overflowY: 'scroll', scrollbarWidth: 'none', msOverflowStyle: 'none'}}></iframe>
