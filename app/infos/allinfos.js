          ...
          <li>
            ...
            <ul>
              <li>
                <div
                  ...
                  onClick={handleOpenPeace}
                  style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}
                >
                  {openPeace === 1 ? (
                    <svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                      <polygon points="1.5,1.5 13.5,7.5 1.5,13.5" fill="#3C3D3D" />
                    </svg>
                  ) : (
                    <svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                      <polygon points="1.5,1.5 7.5,13.5 13.5,1.5" fill="#3C3D3D" />
                    </svg>
                  )}
                  <span>&nbsp;Team: The Peace Ambassadors</span>
                </div>
                {openPeace === 0 && (
                  <div style={{ paddingLeft: '5.2%' }}>
                    <div className='bg-zinc-300 rounded-md p-2 text-neutral-800 font-sans'>
                      <span className='underline text-green-600'>Conducted in Season 2023</span>
                      <br />
                      <span className='font-medium'>Project Name</span>: SERENE <br />
              ...
              <li>
                ...
                >
                  ...
                  <span>&nbsp;Team: Createch</span>
                </div>
                {openCreatech === 0 && (
                  <div style={{ paddingLeft: '5.2%' }}>
                    <div className='bg-zinc-300 rounded-md p-2 text-neutral-800 font-sans'>
                      <span className='underline text-green-600'>Conducted in Season 2022</span>
                      <br />
                      <span className='font-medium'>Project Name</span>: ROOT<br />
                ...
                {openAlphabit === 0 && (
                  <div style={{ paddingLeft: '5.2%' }}>
                    <div className='bg-zinc-300 rounded-md p-2 text-neutral-800 font-sans'>
                      <span className='underline text-green-600'>Conducted in Season 2022</span>
                      <br />
                      <span className='font-medium'>Project Name</span>: FITIFY <br />
            ...
            {/* <ul>
                        <li>
                            ...
                            <span className='text-zinc-700' onClick={handleOpenPeace}><span>&emsp;{openPeace == 1 && <span><svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                        <polygon points="1.5,1.5 13.5,7.5 1.5,13.5" fill="black" />
                    </svg></span>}{openPeace == 0 && <spa><svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                        <polygon points="1.5,1.5 7.5,13.5 13.5,1.5" fill="black" />
                    </svg></spa>}</span>&nbsp;Team:  The Peace Ambassadors</span>
                        ...
                        <li>
                            ...
                            <span className='text-zinc-700' onClick={handleOpenCreatech}><span>&emsp;{openCreatech == 1 && <span><svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                        <polygon points="1.5,1.5 13.5,7.5 1.5,13.5" fill="black" />
                    </svg></span>}{openCreatech == 0 && <span><svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                        <polygon points="1.5,1.5 7.5,13.5 13.5,1.5" fill="black" />
                    </svg></span>}</span>&nbsp;Team:  Createch</span>
                        ...
                        <li>
                            ...
                            <span className='text-zinc-700'onClick={handleOpenAlphabit}><span>&emsp;{openAlphabit == 1 && <span><svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                        <polygon points="1.5,1.5 13.5,7.5 1.5,13.5" fill="black" />
                    </svg></span>}{openAlphabit == 0 && <span><svg width="15" height="15" xmlns="http://www.w3.org/2000/svg">
                        <polygon points="1.5,1.5 7.5,13.5 13.5,1.5" fill="black" />
                    </svg></span>}</span>&nbsp;Team: AlphaBit&apos;s AI</span>
