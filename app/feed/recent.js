    ...
    <div class="mt-3">
        ...
        <hr/>
            ...
            <ul style={{listStyleType: "none"}}>
                ...
                <li>
                <p class="text-justify"><span class="text-sm font-semibold">[August, 2022]</span> I have started research under the supervision of Mr. G M Shahariar Shibli, Faculty, Department of Computer Science and Engineering, Ahsanullah University of Science and Technology.</p>
                </li>
            </ul>
            </div>
        <hr/>
