        ...
        <hr/>
            <div>
                ...
                <ul style={{listStyleType: "none"}}>
                    ...
                    <p>[<span class="text-sky-400">Abstract</span>] [<span class="text-sky-400">PDF</span>] [<span class="text-sky-400">Code & Dataset</span>] [<span class="text-sky-400">Presentation</span>] [<span class="text-sky-400">Citation bib</span>]</p>
                    </li>
                </ul>
            </div>
            <hr/>
                ...
                <ul style={{listStyleType: "none"}}>
                    <li>
                        <p> 
                            ...
                            <span  class="text-sky-400"> <a href="https://2023.emnlp.org/">[Under review @ EMNLP 2023]</a></span>
                        </p> 
                    </li>
                    <li>
                        <p> 
