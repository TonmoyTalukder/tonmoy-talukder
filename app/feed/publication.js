        ...
        <hr/>
            <div>
                ...
                <ul style={{listStyleType: "none"}}>
                    <li>
                    <p class="text-justify"><span class="text-sm font-semibold">📌 [July, 2023]</span> <span class="text-sky-600">Rank Your Summaries: Enhancing Bengali Text Summarization via Ranking-based Approach</span></p>
                    <p class="text-justify"><span class="font-semibold">Authors: </span> <span class="font-semibold text-orange-500">Tonmoy Talukder</span>, Rafin Alam Khan Sotez, Md. Tanvir Rouf Shawon and G. M. Shahariar </p>
