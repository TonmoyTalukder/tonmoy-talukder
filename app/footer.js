...
const Footer = () => {
  ...
  return (
    ...
    <div style={{paddingLeft: "5.25rem"}} className="mt-5 py-7 text-left grid grid-cols-12 gap-4">
    ...
    <h2 className="text-xl font-semibold">Find Me: 👉</h2>
        <ul>
            ...
            <li  className="social-icon">
                <div className="social-icon">
                    ...
                    <span className="social-name text-orange-700 hover:text-orange-400 hover:underline"><a href="https://twitter.com/TonmoyTalukder_" target="_blank" rel="noreferrer">X(Twitter)</a></span>
                </div>
            </li>
        </ul>
        <br></br>
        ...
        <div style={{paddingRight: "5.25rem"}} className="col-span-6 text-special">
            <h2 className="text-xl font-semibold">I write in: 🖊️</h2>
            <ul className="text-right">
            <li className="social-icons-wrapper2">
            <div className="social-icon">
        ...
        <br></br>
        <h2 className="text-xl font-semibold">Write me: ✍️</h2>
        ...
        <div style={{paddingLeft: "5.25rem"}} className="text-left">
            <br></br>
            <span>&copy; {currentYear}, Tonmoy Talukder. All rights reserved.</span><br></br>
            <span className="font-sans text-xs subpixel-antialiased text-slate-500">This site has been developed by myself using NEXT.JS.</span>
        </div>
        <br></br>
        <br></br>
